...
p1 <- p %>% filter (never_married == 1 |  first_child_yob>1944 | is.na(first_child_yob)
                    & birthyear<1930 & previousmarriages==0)

filter age at first birth between 13 and 50
(kids =0) or fcyob >1944
birth year <1931 >1899
